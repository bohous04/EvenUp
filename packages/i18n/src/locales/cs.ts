...
export const cs = {
  ...
  'group.fxLock': 'Zamknout kurz',
  'group.fxLockTitle': 'Zamknout kurz výměny pro tuto skupinu',
  'group.fxLockHint':
    'Po zamknutí se všechny výdaje v jiných měnách přepočítají kurzem, který zadáte. Kurz se už nebude měnit podle denních kurzů.',
  'group.fxLockRate': 'Kurz (1 {quote} = ? {base})',
  'group.fxLockSubmit': 'Zamknout',
  'group.fxUnlock': 'Odemknout kurz',
  'group.fxLocked': 'Kurz zamknutý: {rate}',
  ...
  'activity.allTypes': 'Vše',
  'activity.empty': 'Zatím žádná aktivita',
  'activity.loadMore': 'Načíst starší',
