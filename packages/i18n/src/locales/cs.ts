...
export const cs = {
  ...
  'admin.errors': 'Chyby',
  'admin.billing.title': 'Předplatné a aktivita',
  'admin.billing.desc':
    'Kolik máte předplatných, kolik kreditů je v oběhu a jak si vedou poslední dny.',
  'admin.billing.mrr': 'Měsíční výnos',
  'admin.billing.active': 'Aktivní',
  'admin.billing.trialing': 'na zkoušku',
  'admin.billing.canceling': 'Končí',
  'admin.billing.cancelingHint': 'do konce období',
  'admin.billing.credits': 'Kredity v oběhu',
  'admin.billing.creditsHint': 'nakoupené, nespotřebované',
  'admin.billing.signups': 'Nové účty (30 dní)',
  'admin.billing.scans': 'Skenování (30 dní)',
  'admin.billing.stripe-not-configured': 'Stripe není na této instanci nastavený.',
  'admin.billing.stripe-unreachable': 'Stripe se nedařilo oslovit.',
  'admin.col.vip': 'VIP',
