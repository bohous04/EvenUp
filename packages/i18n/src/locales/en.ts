...
export const en: Messages = {
  ...
  'admin.users': 'Users',
  'admin.errors': 'Errors',
  'admin.billing.title': 'Subscriptions and activity',
  'admin.billing.desc':
    'How many subscribers you have, how many credits are outstanding, and how the last 30 days have gone.',
  'admin.billing.mrr': 'Monthly revenue',
  'admin.billing.active': 'Active',
  'admin.billing.trialing': 'on trial',
  'admin.billing.canceling': 'Ending',
  'admin.billing.cancelingHint': 'at period end',
  'admin.billing.credits': 'Credits outstanding',
  'admin.billing.creditsHint': 'bought, unspent',
  'admin.billing.signups': 'New accounts (30 days)',
  'admin.billing.scans': 'Scans (30 days)',
  'admin.billing.stripe-not-configured': 'Stripe is not configured on this instance.',
  'admin.billing.stripe-unreachable': 'Stripe could not be reached.',
  'admin.col.vip': 'VIP',
  ...
  'group.fxLock': 'Lock rate',
  'group.fxLockTitle': 'Lock the exchange rate for this group',
  'group.fxLockHint':
    'Once locked, every expense in another currency converts at the rate you enter, instead of the daily rate.',
  'group.fxLockRate': 'Rate (1 {quote} = ? {base})',
  'group.fxLockSubmit': 'Lock',
  'group.fxUnlock': 'Unlock rate',
  'group.fxLocked': 'Rate locked: {rate}',
  ...
  'activityType.member.merged': 'Member merged',
