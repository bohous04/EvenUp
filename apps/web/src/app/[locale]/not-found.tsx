 ...
 * keeps its stylesheets and Header — only the outer `<html>` tag is replaced
 * by Next with its own `<html id="__next_error__">` for a true 404 response,
 * a Next limitation this file can't work around.
 *
