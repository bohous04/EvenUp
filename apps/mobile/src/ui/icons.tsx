...
/**
 * Brand logo marks, kept byte-identical to web's
 * `apps/web/src/components/icons.tsx` so the OAuth buttons match across
 * platforms. Google's brand guidelines require the multicolour "G" — a
 * monochrome icon-font glyph is not a compliant substitute.
 */

/** Official multicolour Google "G", for the OAuth button. */
...
/**
 * The Apple logo mark. Only needed where the native
 * `AppleAuthenticationButton` isn't used (Android, or a custom row).
 */
export function AppleLogo({ size = 18, color = '#000' }: { size?: number; color?: string }) {
  return (
